...
import removeLastChars from './utils/removeLastChars.js';
...
function computeOriginalStyle(drawerElement) {
  ...
  const height = boundingClientRect.height - borderBottomWidth - borderTopWidth - paddingBottom - paddingTop;
